...
std::multimap<t_myVector2, t_myVector2> t_algoMaxRects::pack(const std::vector< t_myVector2> &temp, const t_myVector2 &size, bool &fine)
{
   ...
   while (!rects.empty())
   {
      ...
      for (std::list<t_myVector2>::iterator iterRects = rects.begin(); iterRects != rects.end(); iterRects++)
      {
         for (std::list<t_myBox>::iterator iterFreeBoxes = freeBoxes.begin(); iterFreeBoxes != freeBoxes.end(); iterFreeBoxes++)
         {
      ...
      for (std::list<t_myBox>::iterator iterFreeBoxes = freeBoxes.begin(); iterFreeBoxes != freeBoxes.end();)
      {
         ...
         std::list<t_myBox>::iterator blah = iterFreeBoxes++;
      ...
      {
         assert(iterFreeBoxes != freeBoxes.end());
         std::list<t_myBox>::iterator iterFreeBoxes2 = iterFreeBoxes;
         iterFreeBoxes2++;
         ...
         while ( iterFreeBoxes2 != freeBoxes.end())
         {
                  ...
                  c3.x <= b3.x && c3.y <= b3.y)
            {
               ...
               std::list<t_myBox>::iterator blah = iterFreeBoxes2++;
               freeBoxes.erase(blah);
            }
